...
const RegisterPage = () => {
  return (
    <div className="flex-center flex items-center justify-center min-h-screen w-full bg-primary-50 bg-dotted-pattern bg-cover bg-fixed bg-center">
      <div className="max-w-[450px] w-full mx-auto">
        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Velit, quidem
        ex sapiente corporis officiis nulla nisi error provident ullam enim,
        exercitationem quae ducimus, asperiores architecto fugit vero suscipit
        cupiditate fuga?
      </div>
    </div>
  );
