...
const EditConferencePage = async ({params}: { params: { conferenceId: string } }) => {
    const [conferenceData, directionData] = await Promise.all([getConferenceById(Number(params.conferenceId)), getAllDirections()]);
