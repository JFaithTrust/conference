...
const Footer = () => {
  return (
    <footer className="bg-indigo-400 p-2">
   <div className="mx-auto w-full max-w-screen-xl">
      <div className="grid grid-cols-1 gap-8  py-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
          <div className="ml-8 flex  flex-col items-center sm:ml-14 sm:items-center md:items-start">
            ...
            />
            <h2 className="mt-4 text-center font-bold md:text-left">Conference App</h2>
          ...
          <div className="order-2 flex flex-col items-center sm:ml-14  sm:items-center md:order-5  md:mx-10 md:items-start lg:order-2">
          ...
          <div className="order-3 flex flex-col  items-center sm:items-center md:mx-16 md:items-start lg:mx-10">
          ...
          <div className="order-4 flex flex-col  items-center sm:mx-10 sm:items-center md:order-2 md:mx-8 md:items-start lg:order-4">
            <h3 className="mb-4 text-center font-bold md:text-left">XARITADA</h3>
